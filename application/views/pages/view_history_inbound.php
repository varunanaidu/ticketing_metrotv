...
<div class="card mb-3">
	...
	<div class="card-body">
		<div class="table-responsive">
			<table class="table table-bordered" id="historyInboundTable" width="100%" cellspacing="0" style="text-align: center;">
				<thead>
					<tr>
						<th>Start Date</th>
						<th>End Date</th>
					...
					<div class="col-md-12">
						...
						<div class="table-responsive">
							<table width="100%">
								...
								<tr>
									<td style="min-width: 250px;"> Request By </td>
									<td style="width: 2%"> : </td>
									<td style="width: 88%" id="userSender"></td>
								</tr>
								<tr>
